                                ...
                                <div class="iq-card">
                                    <div class="iq-card-header d-flex justify-content-between">
                                        <div class="iq-header-title">
                                            <h4 class="card-title">Add Movie by Tmdb</h4>
                                        </div>
                                    </div>
                                    <div class="iq-card-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <form action="../add?type=movie2" method="POST">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" placeholder="TMDB ID" name="tmdbid">
                                                    </div>
                                                    <div class="form-group ">
